 ...
 */
public final class RectangularTriangleCounter
        implements GeometryFiguresData {

    private double baseData;
    private double heightData;

    public RectangularTriangleCounter(final List<String> data) {
    ...
    public double countFigureArea() {
        return (this.baseData * this.heightData) / 2;
    }
}
