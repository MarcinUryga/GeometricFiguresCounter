...
public final class EquilateralTriangleCounter implements GeometryFiguresData {

    private double baseData;

    public EquilateralTriangleCounter(final List<String> data) {
    ...
    public double countFigureArea() {
        return (this.baseData * baseData * Math.sqrt(3)) / 4;
    }
